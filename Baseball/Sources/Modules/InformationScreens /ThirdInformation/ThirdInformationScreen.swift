...
struct ThirdInformationScreen: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ...
                Text("Technique analysis, drills from MLB pros in one app.")
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .foregroundStyle(Color.init(red: 228/255, green: 230/255, blue: 237/255))
...
#Preview {
    ThirdInformationScreen(path: .constant(.init()))
}
